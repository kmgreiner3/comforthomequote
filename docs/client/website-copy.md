...
- **BETTER — IKO Cambridge.** "Dependable Performance. Excellent Value." Architectural asphalt shingle offering dependable protection, impact resistance, and a wide selection of colors. Highlights: Class 3 impact resistance classification · 110 MPH Limited Wind Warranty · Up to 130 MPH Limited High-Wind Warranty when installed according to applicable IKO requirements* · Class A fire resistance · Limited Lifetime manufacturer warranty* · 10-year Iron Clad Protection period* · 5-Year Workmanship Guarantee.
- **BEST — TAMKO Titan XT.** "Enhanced Protection. Premium Performance." Premium architectural shingle for homeowners looking for enhanced wind performance, impact resistance, and a longer workmanship guarantee. Highlights: UL 2218 Class 3 impact resistance · 110 MPH standard Limited Wind Warranty · Up to 160 MPH Limited Wind Warranty when installed according to applicable TAMKO high-wind requirements* · Limited Lifetime manufacturer warranty* · 10-year Full Start non-prorated warranty period* · 10-Year Workmanship Guarantee. Present as "Upgrade to Titan XT +$[DELTA] or approximately +$[MONTHLY DIFF]/month".

**Underlayment step:** "What's Under Your Shingles Matters. Underlayment is installed directly over your roof decking and underneath your shingles. If shingles become damaged, lifted, or removed during severe weather, your underlayment provides an important secondary layer of protection against water intrusion."

- **STANDARD — Synthetic (INCLUDED):** Florida-approved synthetic underlayment, mechanically fastened. Benefits: approved synthetic underlayment · mechanically fastened · secondary protection beneath your shingles · meets applicable Florida requirements · included with your roofing system.
- **PREMIUM — Full Peel & Stick:** "Enhanced Secondary Water Protection." Self-adhered membrane across the roof deck creating a continuous secondary water barrier. Benefits: self-adhered directly to roof decking · continuous secondary water barrier · enhanced water-intrusion protection · additional severe-weather protection · premium roofing-system upgrade. "+5 YEARS added to your Workmanship Guarantee."

**Protection level confirmation:** BETTER (IKO+Syn, 5yr) / BETTER+ (IKO+P&S, 10yr) / BEST (Titan+Syn, 10yr) / BEST+ (Titan+P&S, 15yr). "YOUR ROOF IS [LEVEL]".

**What's included (12 tiles — short copy per tile, all marked INCLUDED):**
...
**Review:** "Here's What You Built" — shingle, color, underlayment, drip edge, protection level, guarantee, price + monthly. CTAs: [EDIT MY ROOF] / [I'M READY TO MOVE FORWARD] (strongest CTA on the page).
...
**Homeowner info:** "We need this information to begin scheduling, permitting, and preparing your project for installation." Fields: full name, phone, email, property address (auto-filled), billing address, preferred contact method.

**Pre-installation visit:** "Before installation, your project manager will visit the property to document existing conditions and take the necessary pre-installation photos. What date works best for our project manager to come out?" + Morning / Afternoon / No Preference.
